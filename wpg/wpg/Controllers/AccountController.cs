    ...
    [HttpGet]
        ...
        public async Task<object> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                result = await _IAccount.Login(model.Email, model.Password, model.RememberMe);

                if (result == "Success")
                {
                    IdentityUser appUser = new IdentityUser(model.Email);
                    appUser.UserName = model.Email;
                    appUser.Email = model.Email;
                    appUser.Id = "bd52ff8f-b1ef-48dc-bc7f-271c79885c89";

                   var tokenResponse = await GenerateJwtToken(model.Email, appUser);
                    return token = tokenResponse.ToString();
                }
                return token;
        ...
        //[HttpGet]
        //public bool Register(string returnUrl = null)
        //{
        //    ViewData["ReturnUrl"] = returnUrl;
        //    // return View();
